...
public class PawnController : EntityComponent<ThinkerPlayer>
{
	...
	public void Simulate( IClient cl )
	{
		...
		if ( groundEntity.IsValid() )
		{
			if ( !Grounded )
			{
				...
				AddEvent( "grounded" );
				if ( FallDistance < -700f )
				{
					Entity.TakeDamage( DamageInfo.Generic( (float)Math.Pow( -FallDistance / 300, 4 ) ) );
		...
		else
		{
			...
			FallDistance = Entity.Velocity.z;
		}
